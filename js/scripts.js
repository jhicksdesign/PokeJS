$('form').on('submit', function (event) {  // Triggers function on form submit
    ...
    let names = $('input[type=text]').val().replace(/\./g, '').toLowerCase();   // Declaring name variable, gets input from form, removes periods, and changes text input to lower case
